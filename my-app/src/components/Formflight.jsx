...
import React, { useState } from "react";
import { TextField, Button, Box, MenuItem, IconButton, Typography } from "@mui/material";
import { FlightTakeoff, SwapHoriz, CalendarToday, People, LocalOffer, Send } from "@mui/icons-material";
import { useNavigate } from "react-router-dom";
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", flex: 1, minWidth: 250 }}>
          <TextField
            ...
            fullWidth
            InputProps={{
              startAdornment: <FlightTakeoff sx={{ mr: 1 }} />,
              endAdornment: (
                <IconButton>
                  <SwapHoriz />
                </IconButton>
        ...
        >
          ...
          <MenuItem value="2 Passengers, Business">2 Passengers, Business</MenuItem>
          <MenuItem value="3 Passengers, First Class">3 Passengers, First Class</MenuItem>
        </TextField>
      </Box>
